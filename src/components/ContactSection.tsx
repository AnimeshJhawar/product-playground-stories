      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="block glass-card bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 backdrop-blur-sm rounded-2xl p-6 border-2 border-blue-200 dark:border-blue-700 shadow-lg hover:shadow-xl transition-all cursor-pointer mx-auto max-w-md"
          >
            <div className="text-center">
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-2">Want to book a 1:1?</h3>
              <p className="text-slate-600 dark:text-slate-400 mb-4">Schedule a personalized session to discuss your product management journey</p>
              <div className="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold">
                Book Session
              </div>
            </div>
          </motion.a>
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-600 dark:text-slate-300">jhawaranimesh12@gmail.com</div>
                    </div>
                  </motion.a>
