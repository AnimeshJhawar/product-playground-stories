...
const roles = [
  ...
  },
  {
    ...
    location: "Remote",
    fullDescription: "Developing Meditally, a comprehensive POS application designed specifically for rural pharmacies to revolutionize inventory management in underserved healthcare markets. This solution addresses critical gaps in pharmaceutical supply chain management in rural India.",
    achievements: [
      "Designed and developed Meditally POS system for rural pharmacy inventory management",
